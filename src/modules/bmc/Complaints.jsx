...
export default function Complaints() {
  ...
  const accountUsername = localStorage.getItem("bmc_name") || "BMC User";
  const [bmcName, setBmcName] = useState(accountUsername);
  const userId = localStorage.getItem("bmc_user_id") || "";
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-5">
            <div>
              ...
              <input
                ...
                type="text"
                value={bmcName}
                onChange={(e) => setBmcName(e.target.value)}
