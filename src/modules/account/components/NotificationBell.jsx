...
import { NOTIF_STYLES } from "../utils/notificationEngine";

export default function NotificationBell({ notifs, onMarkRead, onMarkAll, onDismiss, onClearAll, onAccept }) {
            ...
            notifs.map((n) => {
              ...
              return (
                <div key={n.id} className={`notif-item${n.read ? "" : " unread"}`}>
                  ...
                  <div className="notif-body" onClick={() => onMarkRead(n.id)}>
