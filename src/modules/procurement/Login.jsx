...
export default function ProcurementLogin() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (user.role !== "ProcurementInputs") {
        setError(`Not authorized - This is a ${user.role} account. Please use Procurement & Inputs credentials.`);
        return;
      }
